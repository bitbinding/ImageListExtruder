...
#include "../../ImageListExtruder/imagepreviewwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImagePreviewWidget_t, stringdata) + ofs \
...
void *ImagePreviewWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImagePreviewWidget.stringdata))
